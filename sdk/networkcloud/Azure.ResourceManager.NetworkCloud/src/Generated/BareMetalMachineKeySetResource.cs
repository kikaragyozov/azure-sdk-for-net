...
namespace Azure.ResourceManager.NetworkCloud
{
    ...
    public partial class BareMetalMachineKeySetResource : ArmResource
    {
        ...
        public static ResourceIdentifier CreateResourceIdentifier(Guid subscriptionId, string resourceGroupName, string clusterName, string bareMetalMachineKeySetName)
        {
        ...
        public virtual async Task<Response<BareMetalMachineKeySetResource>> GetAsync(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _bareMetalMachineKeySetRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<BareMetalMachineKeySetResource> Get(CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _bareMetalMachineKeySetRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                if (response.Value == null)
                    throw new RequestFailedException(response.GetRawResponse());
                return Response.FromValue(new BareMetalMachineKeySetResource(Client, response.Value), response.GetRawResponse());
            }
        ...
        public virtual async Task<ArmOperation> DeleteAsync(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _bareMetalMachineKeySetRestClient.DeleteAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
                var operation = new NetworkCloudArmOperation(_bareMetalMachineKeySetClientDiagnostics, Pipeline, _bareMetalMachineKeySetRestClient.CreateDeleteRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
        ...
        public virtual ArmOperation Delete(WaitUntil waitUntil, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _bareMetalMachineKeySetRestClient.Delete(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                var operation = new NetworkCloudArmOperation(_bareMetalMachineKeySetClientDiagnostics, Pipeline, _bareMetalMachineKeySetRestClient.CreateDeleteRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<ArmOperation<BareMetalMachineKeySetResource>> UpdateAsync(WaitUntil waitUntil, BareMetalMachineKeySetPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = await _bareMetalMachineKeySetRestClient.UpdateAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch, cancellationToken).ConfigureAwait(false);
                var operation = new NetworkCloudArmOperation<BareMetalMachineKeySetResource>(new BareMetalMachineKeySetOperationSource(Client), _bareMetalMachineKeySetClientDiagnostics, Pipeline, _bareMetalMachineKeySetRestClient.CreateUpdateRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual ArmOperation<BareMetalMachineKeySetResource> Update(WaitUntil waitUntil, BareMetalMachineKeySetPatch patch, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                var response = _bareMetalMachineKeySetRestClient.Update(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch, cancellationToken);
                var operation = new NetworkCloudArmOperation<BareMetalMachineKeySetResource>(new BareMetalMachineKeySetOperationSource(Client), _bareMetalMachineKeySetClientDiagnostics, Pipeline, _bareMetalMachineKeySetRestClient.CreateUpdateRequest(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, patch).Request, response, OperationFinalStateVia.Location);
                if (waitUntil == WaitUntil.Completed)
        ...
        public virtual async Task<Response<BareMetalMachineKeySetResource>> AddTagAsync(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (await CanUseTagResourceAsync(cancellationToken: cancellationToken).ConfigureAwait(false))
                {
                    ...
                    var originalResponse = await _bareMetalMachineKeySetRestClient.GetAsync(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken).ConfigureAwait(false);
        ...
        public virtual Response<BareMetalMachineKeySetResource> AddTag(string key, string value, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                if (CanUseTagResource(cancellationToken: cancellationToken))
                {
                    ...
                    var originalResponse = _bareMetalMachineKeySetRestClient.Get(Guid.Parse(Id.Parent.Parent.Parent.Name), Id.Parent.Parent.Name, Id.Parent.Name, Id.Name, cancellationToken);
                    return Response.FromValue(new BareMetalMachineKeySetResource(Client, originalResponse.Value), originalResponse.GetRawResponse());
                }
                else
                {
